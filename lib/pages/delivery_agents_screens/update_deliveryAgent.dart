...
class UpdateDeliveryAgent extends StatefulWidget {
  const UpdateDeliveryAgent({Key? key}) : super(key: key);

  @override
  State<UpdateDeliveryAgent> createState() => _UpdateDeliveryAgentState();
}

class _UpdateDeliveryAgentState extends State<UpdateDeliveryAgent> {
  File? insidePic;
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text("Update",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600,color: AppColors.whitecolor),),
                            )
                          ],
                        )
                      ],
